...
class SEResnet(nn.Module):
    def __init__(self,embedding):
        ...
        self.stage1 = nn.ModuleList([residueblcok(conv_list[0],conv_list[0],True) if i == 0 else residueblcok(conv_list[0],conv_list[0]) for i in range(2)])
        self.stage2 = nn.ModuleList([residueblcok(conv_list[0],conv_list[1],True) if i == 0 else residueblcok(conv_list[1],conv_list[1]) for i in range(2)])
        self.stage3 = nn.ModuleList([residueblcok(conv_list[1],conv_list[2],True) if i == 0 else residueblcok(conv_list[2],conv_list[2]) for i in range(2)])
        self.stage4 = nn.ModuleList([residueblcok(conv_list[2],conv_list[3],True) if i == 0 else residueblcok(conv_list[3],conv_list[3]) for i in range(2)])
